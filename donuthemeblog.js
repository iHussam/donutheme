var backgroundElements = "#main-wrapper,.small-thumbnail,.post-labels a,.copyright-inner,.tr-caption,.popular-post-item .item .item_content .item_labels a,#header-navigation,#header-search,#header-search input,#myBar,.popular-post-list .item_labels li a",
    colorElements = ".col-right,.post-body h2,.post-body h3,.post-body h4,#popular-wrapper,#footer-wrapper,.post-outer h1.post-title,#grouped-slide .owl-nav button,#sidebar h3.title,.blog-posts .post-item,a:not(.popular-post-list .item_content a),.popular-post-list .item_labels li a,.nav>li>ul,.lds-ripple div";
